<%@page contentType="text/html" pageEncoding="UTF-8" %>
	...
	<head>
		...
		<link rel="icon" href="images/smallLogo.jpg" type="image/png" sizes="10x10">
	</head>
	...
	<body>
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-12">
					<a href="LoginServlet?mode=homeOnly"><img src="images/smallLogo.jpg"></a><span class="text-logo">Add
						Product</span>
				</div>
			</div>
			<br>
			<div class="row">
				<div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
					<div class="tm-bg-primary-dark tm-block tm-block-h-auto">
						<form class="tm-edit-product-form" action="AddProductServlet" method="POST"
							enctype="multipart/form-data" onsubmit="return validateForm()" name="myForm">
							<div class="row tm-edit-product-row">
								<div class="col-xl-6 col-lg-6 col-md-12">
									<div class="form-group mb-3">
										<label for="name">Product Name</label> <input type="text" name="productName"
											class="form-control validate" /><br>
										<input type="hidden" value=1 name="productStatus">
									</div>

									<div class="form-group mb-3">
										<label for="category">Category</label> <input type="text" name="productBrand"
											class="form-control validate" /><br>
									</div>
								...
								<div class="col-6">
									<button type="submit" class="btn btn-dark btn-block text-uppercase">Add
										Product</button>
								</div>
								<div class="col-6">
